...
public class SharedDocumentCell extends FrameLayout implements MediaController.FileDownloadProgressListener {
    ...
    public SharedDocumentCell(Context context, AttributeSet attrs) {
        this(context);
    }
    public SharedDocumentCell(Context context) {
        ...
        extTextView.setTypeface(FontManager.instance().getTypeface());
        ...
        dateTextView.setTypeface(FontManager.instance().getTypeface());
