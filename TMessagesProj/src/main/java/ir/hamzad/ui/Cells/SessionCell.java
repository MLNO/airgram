...
public class SessionCell extends FrameLayout {
    ...
    public SessionCell(Context context) {
        ...
        onlineTextView.setTypeface(FontManager.instance().getTypeface());
        ...
        detailTextView.setTypeface(FontManager.instance().getTypeface());
        ...
        detailExTextView.setTypeface(FontManager.instance().getTypeface());
