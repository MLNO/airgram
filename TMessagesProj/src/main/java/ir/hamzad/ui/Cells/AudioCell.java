...
public class AudioCell extends FrameLayout {
    ...
    public AudioCell(Context context) {
        ...
        genreTextView.setTypeface(FontManager.instance().getTypeface());
        ...
        authorTextView.setTypeface(FontManager.instance().getTypeface());
        ...
        timeTextView.setTypeface(FontManager.instance().getTypeface());
