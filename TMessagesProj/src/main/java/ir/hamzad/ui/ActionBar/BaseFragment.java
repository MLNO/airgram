    ...
    protected void setParentLayout(ActionBarLayout layout) {
        if (parentLayout != layout) {
            ...
            if (parentLayout != null && actionBar == null) {
                ...
                int pic= SkinMan.currentSkin.actionSmallPicture();
                // :ramin
                if(pic==0)
                    actionBar.setBackgroundColor(
                            SkinMan.currentSkin.actionbarColor()//ColorUtils.getColor(R.color.primary)
                    );
                else {
                    Drawable d=ContextCompat.getDrawable(actionBar.getContext(), pic);
                    Utils.setBackground(actionBar, d);
                }
                //actionBar.setBackgroundColor(0xff54759e);
                actionBar.setItemsBackgroundColor(//R.drawable.bar_selector_f
                        SkinMan.barSelector(parentLayout.getContext()));
            }
        }
    }
