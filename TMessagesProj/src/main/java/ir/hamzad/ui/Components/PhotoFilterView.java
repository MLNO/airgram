...
public class PhotoFilterView extends FrameLayout {
    ...
    public PhotoFilterView(Context context, Bitmap bitmap, int rotation) {
        ...
        cancelTextView.setTypeface(FontManager.instance().getTypeface());
        ...
        doneTextView.setTypeface(FontManager.instance().getTypeface());
        ...
        for (int a = 0; a < 4; a++) {
            ...
            curveTextView[a].setTypeface(FontManager.instance().getTypeface());
        ...
        tintShadowsButton.setTypeface(FontManager.instance().getTypeface());
        ...
        tintHighlightsButton.setTypeface(FontManager.instance().getTypeface());
