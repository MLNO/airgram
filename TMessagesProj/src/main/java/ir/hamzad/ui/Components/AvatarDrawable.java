...
public class AvatarDrawable extends Drawable {
    ...
    //:ramin
    public static void changeIndexColor(int index, int color){
        arrColorsProfilesBack[index]=color;
    }
    public static void changeIndexBarSelector(int index, int color){
        arrColorsButtons[index]=color;
    }
