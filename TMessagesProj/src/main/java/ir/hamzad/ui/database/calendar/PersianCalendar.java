package org.telegram.ui.database.calendar;
...
public class PersianCalendar {
    ...
    public PersianCalendar(Date paramDate) {
        ...
        */
        ...
        long miDate = (paramDate.getTime() + ((long) (TimeZone.getDefault().inDaylightTime(paramDate) ? TimeZone.getDefault().getDSTSavings() : 0))) - new Date("01/01/1900").getTime();
        long time = miDate / 1000;
        S = (int) (time % 60);
        time /= 60;
        M = (int) (time % 60);
        H = (int) ((time / 60) % 24);
