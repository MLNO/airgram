...
public class SendMessagesHelper implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void sendSticker(TLRPC.Document document, long peer, MessageObject replyingMessageObject, boolean asAdmin) {
        sendSticker(document,peer,replyingMessageObject);
    }
    ...
    public static void prepareSendingPhoto(String imageFilePath, Uri imageUri, long dialog_id, MessageObject reply_to_msg, CharSequence caption, boolean asAdmin) {
        prepareSendingPhoto(imageFilePath, imageUri, dialog_id, reply_to_msg, caption);
    }
    public static void prepareSendingPhoto(String imageFilePath, Uri imageUri, long dialog_id, MessageObject reply_to_msg, CharSequence caption, boolean asAdmin, boolean asImage) {
        prepareSendingPhoto(imageFilePath, imageUri, dialog_id, reply_to_msg, caption);
    }
    ...
    public static void prepareSendingPhotos(ArrayList<String> paths, ArrayList<Uri> uris, final long dialog_id, final MessageObject reply_to_msg, final ArrayList<String> captions, final boolean asAdmin, final boolean asImageIfDocument) {
        prepareSendingPhotos(paths, uris, dialog_id, reply_to_msg, captions);
    }
